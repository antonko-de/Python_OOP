...
class EmailValidator:
    ...
    def __init__(self, min_length:str, mails:list, domains:list) -> None:
    ...
    def validate(self, email:str) ->bool:
        ...
        if self.__is_name_valid(name=name) and self.__is_domain_valid(domain=domain) and self.__is_mail_valid(mail=mail):
            return True
        else:
            return False
